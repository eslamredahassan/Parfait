      ...
      switch (interaction.customId) {
        case "#ap_report": {
          ...
          const tryout = new TextInputComponent()
            ...
            .setLabel(
              `Tell us when you are available for a tryout`.substring(0, 45),
            )
            .setMinLength(3)
            .setMaxLength(65)
            .setRequired(true)
          ...
          const usual = new TextInputComponent()
            ...
            .setLabel(
              `What are your usual days of play and hours?`.substring(0, 45),
            )
            .setMinLength(3)
            .setMaxLength(65)
            .setRequired(true)
          ...
          const start = new TextInputComponent()
            ...
            .setLabel(
              `When did you start playing Smash Legends?`.substring(0, 45),
            )
            .setMinLength(2)
            .setMaxLength(65)
            .setRequired(true)
      ...
      await threads.send({
        embeds: [
          new MessageEmbed()
            .setColor(`${color.gray}`)
            .setTitle(
              `${emojis.app} ${interaction.user.username}'s Tryout Rate`,
            )
            .setAuthor({
